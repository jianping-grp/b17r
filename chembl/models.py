...
class AssayParameters(models.Model):
    assay_param_id = models.IntegerField(primary_key=True)
    assay = models.ForeignKey('Assays', models.DO_NOTHING)
    parameter_type = models.ForeignKey('ParameterType', models.DO_NOTHING, db_column='parameter_type')
...
class AtcClassification(models.Model):
    who_name = models.CharField(max_length=150, blank=True, null=True)
    ...
    level4_description = models.CharField(max_length=150, blank=True, null=True)
...
class ComponentGo(models.Model):
    comp_go_id = models.IntegerField(primary_key=True)
    component = models.ForeignKey('ComponentSequences', models.DO_NOTHING)
...
class CompoundStructuralAlerts(models.Model):
    cpd_str_alert_id = models.IntegerField(primary_key=True)
...
class DrugMechanism(models.Model):
    ...
    mechanism_comment = models.CharField(max_length=500, blank=True, null=True)
    selectivity_comment = models.CharField(max_length=100, blank=True, null=True)
    binding_site_comment = models.CharField(max_length=100, blank=True, null=True)
...
class FracClassification(models.Model):
    frac_class_id = models.IntegerField(primary_key=True)
...
class HracClassification(models.Model):
    hrac_class_id = models.IntegerField(primary_key=True)
    active_ingredient = models.CharField(max_length=500)
    level1 = models.CharField(max_length=2)
    level1_description = models.CharField(max_length=2000)
...
class IracClassification(models.Model):
    irac_class_id = models.IntegerField(primary_key=True)
    active_ingredient = models.CharField(max_length=500)
...
class MechanismRefs(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('mec', 'ref_type', 'ref_id'),)


class Metabolism(models.Model):
    met_id = models.IntegerField(primary_key=True)
    drug_record = models.ForeignKey(
        CompoundRecords,
        models.DO_NOTHING,
...
class MetabolismRefs(models.Model):
    metref_id = models.IntegerField(primary_key=True)
...
class MoleculeFracClassification(models.Model):
    mol_frac_id = models.IntegerField(primary_key=True)
...
class MoleculeHierarchy(models.Model):
    molregno = models.ForeignKey(
        ...
        db_column='molregno',
        primary_key=True,
        related_name='molecule'
    )
    parent_molregno = models.ForeignKey(
        MoleculeDictionary,
        models.DO_NOTHING,
        db_column='parent_molregno',
        blank=True, null=True,
        related_name='parent_molecule'
    )
    active_molregno = models.ForeignKey(
        MoleculeDictionary,
        models.DO_NOTHING,
        db_column='active_molregno',
        blank=True, null=True,
        related_name='active_molecule'
    )
...
class MoleculeHracClassification(models.Model):
    mol_hrac_id = models.IntegerField(primary_key=True)
...
class MoleculeIracClassification(models.Model):
    mol_irac_id = models.IntegerField(primary_key=True)
...
class MoleculeSynonyms(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('molregno', 'synonyms', 'syn_type'),)
...
class ParameterType(models.Model):
    parameter_type = models.CharField(primary_key=True, max_length=40)
    description = models.CharField(max_length=2000, blank=True, null=True)
...
class ProductPatents(models.Model):
    prod_pat_id = models.IntegerField(primary_key=True)
    product = models.ForeignKey('Products', models.DO_NOTHING)
...
class StructuralAlertSets(models.Model):
    alert_set_id = models.IntegerField(primary_key=True)
...
class TargetDictionary(models.Model):
    ...
    tax_id = models.BigIntegerField(blank=True, null=True)
    organism = models.CharField(max_length=150, blank=True, null=True)
    chembl = models.ForeignKey(ChemblIdLookup, models.DO_NOTHING)
...
class TargetRelations(models.Model):
    ...
    related_tid = models.ForeignKey(
        TargetDictionary,
        models.DO_NOTHING,
        db_column='related_tid',
...
class UsanStems(models.Model):
    usan_stem_id = models.IntegerField(primary_key=True)
